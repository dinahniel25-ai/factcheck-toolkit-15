...
const VisualLab = () => {
  ...
  const verificationTools = [
    ...
    {
      name: 'Decopy.ai AI Image Detector',
      url: 'https://decopy.ai/ai-image-detector/',
      description: 'Detects if images were generated by artificial intelligence',
      icon: '🤖',
      instructions: 'Upload image → Analyze AI probability → Verify results'
    }
  ];
